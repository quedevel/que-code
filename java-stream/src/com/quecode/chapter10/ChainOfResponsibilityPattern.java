...
import com.quecode.chapter10.model.Order;
import com.quecode.chapter10.service.OrderProcessStep;
import com.quecode.chapter10.model.OrderLine;
...
public class ChainOfResponsibilityPattern {
    public static void main(String[] args) {
        /**
         * 10.6 Chain of Responsibility Pattern
         */
        ...
        OrderProcessStep processPaymentStep = new OrderProcessStep(order -> {
            if(order.getStatus() == Order.OrderStatus.IN_PROGRESS){
                System.out.println("processing payment order "+order.getId());
        ...
        OrderProcessStep chain = initStep
