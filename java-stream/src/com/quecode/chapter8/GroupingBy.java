...
public class GroupingBy {
    public static void main(String[] args) {
        ...
        User user1 = new User().setId(9).setName("Alice").setVerified(true).setEmailAddress("alice@innotree.com").setFriendUserIds(Arrays.asList(201,202,203,204));
        User user2 = new User().setId(10).setName("Bob").setVerified(false).setEmailAddress("bob@innotree.com").setFriendUserIds(Arrays.asList(202,203,204));
        User user3 = new User().setId(11).setName("Charlie").setVerified(false).setEmailAddress("charlie@innotree.com").setFriendUserIds(Arrays.asList(201,203,204));
        User user4 = new User().setId(12).setName("David").setVerified(true).setEmailAddress("david@innotree.com").setFriendUserIds(Arrays.asList(203,204));
